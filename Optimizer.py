...
class SGD:
    ...
    def update_params(self, layer):
        ...
        if self.momentum:
            # If layer does not conatin momentum arrays, initialize them
...
class AdaGrad:
    ...
    # Update parameters
    def update_params(self, layer):
        # If layer does not conatin cache arrays, initialize them
...
class Adam:
    ...
    def update_params(self, layer):
        ...
        # Get corrected momentum (self.iteration is 0 at first pass and we need to start with 1)
        ...
        # Vanilla SHG parameter update + normalixation with square rooted cache
